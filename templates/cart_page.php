    ...
    <div class="card-body">
        ...
        <div class="row">
            <div class="col-12 col-sm-12 col-md-2 text-xs-center">
                <img class="img-responsive" src="<?php echo IMG_DIR.$article["nome"].".jpg" ?>" alt="prewiew" width="120" height="80">
            </div>
            <div class="col-12 text-sm-center col-sm-12 text-md-left col-md-6">
                <h4 class="product-name"><strong><?php echo $article["nome"] ?></strong></h4>
                <h4>
                    <small><?php echo $article["descrizione"] ?></small>
                </h4>
            </div>
            <div class="col-12 col-sm-12 text-sm-center col-md-4 text-md-right row">
                <div class="col-3 col-sm-3 col-md-6 text-md-right" style="padding-top: 5px">
                    <h6><strong><?php echo $article["prezzo"] ?> <span class="text-muted">€</span></strong></h6>
                </div>
