                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-4 text-center">
                                    ...
                                    <div class="status fw-bold">
                                        <?php echo $templateParams["stati"]; ?>
                                    </div>

                                    <div class="text-center visual-status">
                                        <!--package--><svg xmlns="http://www.w3.org/2000/svg" width="<?php echo $icons['size'] ?>" height="<?php echo $icons['size'] ?>" fill="currentColor" class="bi bi-box-seam" viewBox="0 0 16 16">
                                        ...
                                        <!--points--><svg xmlns="http://www.w3.org/2000/svg" width="<?php echo $icons['size'] ?>" height="<?php echo $icons['size'] ?>" fill="currentColor" class="bi bi-three-dots text-secondary" viewBox="0 0 16 16">
                                            <path d="M3 9.5a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3zm5 0a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3zm5 0a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3z" />
                                        </svg>
                                        <!--truck--><svg xmlns="http://www.w3.org/2000/svg" width="<?php echo $icons['size'] ?>" height="<?php echo $icons['size'] ?>" fill="currentColor" class="bi bi-truck" viewBox="0 0 16 16">
                                            <path d="M0 3.5A1.5 1.5 0 0 1 1.5 2h9A1.5 1.5 0 0 1 12 3.5V5h1.02a1.5 1.5 0 0 1 1.17.563l1.481 1.85a1.5 1.5 0 0 1 .329.938V10.5a1.5 1.5 0 0 1-1.5 1.5H14a2 2 0 1 1-4 0H5a2 2 0 1 1-3.998-.085A1.5 1.5 0 0 1 0 10.5v-7zm1.294 7.456A1.999 1.999 0 0 1 4.732 11h5.536a2.01 2.01 0 0 1 .732-.732V3.5a.5.5 0 0 0-.5-.5h-9a.5.5 0 0 0-.5.5v7a.5.5 0 0 0 .294.456zM12 10a2 2 0 0 1 1.732 1h.768a.5.5 0 0 0 .5-.5V8.35a.5.5 0 0 0-.11-.312l-1.48-1.85A.5.5 0 0 0 13.02 6H12v4zm-9 1a1 1 0 1 0 0 2 1 1 0 0 0 0-2zm9 0a1 1 0 1 0 0 2 1 1 0 0 0 0-2z" />
                                        </svg>
                                        <!--points--><svg xmlns="http://www.w3.org/2000/svg" width="<?php echo $icons['size'] ?>" height="<?php echo $icons['size'] ?>" fill="currentColor" class="bi bi-three-dots text-secondary" viewBox="0 0 16 16">
                                            <path d="M3 9.5a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3zm5 0a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3zm5 0a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3z" />
                                        </svg>
                                        <!--V tick--><svg xmlns="http://www.w3.org/2000/svg" width="<?php echo $icons['size'] ?>" height="<?php echo $icons['size'] ?>" fill="currentColor" class="bi bi-check-circle" viewBox="0 0 16 16">
