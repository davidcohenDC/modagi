...
<div class="row justify-content-lg-center">
    ...
    <div class="col-10 col-md-8 col-lg-6">
        <div class="btn-group-vertical col-12 ">
            <a href="user-action-page.php?action=1" class="my-3 btn btn-dark fw-bold"> Modifica Dati Utente </a>
            <a href="user-action-page.php?action=2" class="my-3 btn btn-dark fw-bold"> Modifica Password </a>
